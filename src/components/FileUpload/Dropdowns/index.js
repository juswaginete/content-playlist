...
export default function CustomizedSelects() {
  ...
  const handleClick = (event) => {
    ...
    } else if (currentTarget === "remove-modal") {
    ...
    <div className="dropdown-selection-container">
      <FormControl className={classnames(
        ...
        <Select 
          ...
          <MenuItem className={classes.item} value="remove-modal" onClick={handleClick}>Remove Schedule</MenuItem>
          <MenuItem className={classes.item} value="preview-modal" onClick={handleClick}>Preview</MenuItem>
          <MenuItem className={classes.item} value="delete-modal" onClick={handleClick}>Delete</MenuItem>
        </Select>
        ...
        {isPreviewModalShow ? (<PreviewModal modalShow={isPreviewModalShow} modalState={setIsPreviewModalShow} />) : ''}
      </FormControl>
    </div>
  );
}
